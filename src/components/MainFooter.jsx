...
const Footer = () => {
    ...
    return (
      ...
      <div className="bg-green-800 flex flex-col md:flex-row md:justify-around items-center space-y-6 md:space-y-0 p-4">
        {/* Logo */}
      ...
      <div className="bg-gray-800">
        <p className="text-sm text-center">
          <strong>© 2025</strong>, Repuestos y Cabezales
        </p>
      </div>
    </div>
    );
